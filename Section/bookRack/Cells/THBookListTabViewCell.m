...
@interface THBookListTabViewCell()
...
@implementation THBookListTabViewCell
...
- (void)setupLayout{
    ...
    NSString *h_vlf = @"H:|-20-[imageView(==50)]-15-[titleLabel]-25-[updateBtn(<=50)]-20-|";
