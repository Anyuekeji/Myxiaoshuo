...
@interface THGuessYouLikeTabViewCell()
...
@implementation THGuessYouLikeTabViewCell
...
- (void)setupLayout{
    ...
    NSString *h_vlf = @"H:|-20-[imageView(==50)]-15-[titleLabel]-25-[updateBtn(<=0)]-0-|";
