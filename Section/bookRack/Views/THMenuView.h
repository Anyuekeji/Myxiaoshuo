...
@interface THMenuAction : NSObject
@property (nonatomic, readwrite) NSString      *title;
@property (nonatomic, readwrite) UIImage       *image;
@property (nonatomic,copy, readonly) void (^handler)(THMenuAction *action);
+ (instancetype)actionWithTitle:(NSString *)title image:(UIImage *)image handler:(void (^)(THMenuAction *action))handler;
- (instancetype)init NS_UNAVAILABLE;
+ (instancetype)new NS_UNAVAILABLE;
@end
